...
const LeadershipPrinciplesSection = () => {
  ...
  const getStatus = (id) => {
    ...
    if (!data || !data.starStory || data.starStory.trim() === '') {
      return { text: 'No Story', color: 'bg-zinc-700 text-zinc-400' };
    }
                ...
                <div className="border-t border-zinc-800 p-4 space-y-4">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full h-48 p-3 bg-zinc-800 border border-zinc-700 rounded-lg text-white placeholder-zinc-400 focus:outline-none focus:ring-2 focus:ring-amber-500 resize-none"
                    />
                  </div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <select
                      ...
                      className="px-3 py-1 bg-zinc-800 border border-zinc-700 rounded text-white text-sm focus:outline-none focus:ring-2 focus:ring-amber-500"
                    >
